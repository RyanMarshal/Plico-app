...
const mockPoll = {
  ...
  options: [
    { id: 'opt-1', text: 'JavaScript', voteCount: 10, plicoId: 'test-poll-123', createdAt: new Date(), updatedAt: new Date() },
    { id: 'opt-2', text: 'Python', voteCount: 15, plicoId: 'test-poll-123', createdAt: new Date(), updatedAt: new Date() },
    { id: 'opt-3', text: 'TypeScript', voteCount: 5, plicoId: 'test-poll-123', createdAt: new Date(), updatedAt: new Date() }
  ],
  totalVotes: 30,
  winner: { id: 'opt-2', text: 'Python', voteCount: 15, plicoId: 'test-poll-123', createdAt: new Date(), updatedAt: new Date() },
  isTie: false,
  createdAt: new Date(),
  updatedAt: new Date()
}
...
const mockTiePoll = {
  ...
  options: [
    { id: 'opt-1', text: 'JavaScript', voteCount: 10, plicoId: 'test-poll-123', createdAt: new Date(), updatedAt: new Date() },
    { id: 'opt-2', text: 'Python', voteCount: 10, plicoId: 'test-poll-123', createdAt: new Date(), updatedAt: new Date() },
    { id: 'opt-3', text: 'TypeScript', voteCount: 5, plicoId: 'test-poll-123', createdAt: new Date(), updatedAt: new Date() }
  ],
  totalVotes: 25,
  winner: { id: 'opt-1', text: 'JavaScript', voteCount: 10, plicoId: 'test-poll-123', createdAt: new Date(), updatedAt: new Date() },
  isTie: true
}
