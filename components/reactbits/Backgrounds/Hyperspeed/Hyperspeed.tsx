...
const Hyperspeed: FC<HyperspeedProps> = ({ effectOptions = {} }) => {
  ...
  useEffect(() => {
    ...
    // If user prefers reduced motion, show a static gradient instead
    if (shouldReduceMotion) {
      container.style.background = `linear-gradient(135deg, ${mergedOptions.colors.background} 0%, ${mergedOptions.colors.background} 50%, #1a1a2e 100%)`;
      return;
    }
